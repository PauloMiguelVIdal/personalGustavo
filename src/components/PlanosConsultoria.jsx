    ...
    >
      ...
      {planos.map((plano, index) => (
        <div
          ...
          key={index}
          style={{
            background: `linear-gradient(135deg,#${plano.cores.bgCor1}, #${plano.cores.bgCor2})`,
          }}
        >
          <div
            className="containerTitlePackage"
            style={{
              background: `linear-gradient(135deg,#${plano.cores.bgTitle1}, #${plano.cores.bgTitle2})`,
            }}
          >
            <h2 className="titlePackage" style={{ color: `#FFFFFF` }}>
              {plano.titulo}
            </h2>
          </div>
          <h3 className="descTitle" style={{ color: `#FFFFFF` }}>
            {plano.descTitle}
          </h3>

          <p className="desc" style={{ color: `#FFFFFF` }}>
            {plano.desc}
          </p>

          {/* <p className="descountText">
            {plano.preco !== plano.precoReal && (
          ...
          {/* <p className="descountText">
            {plano.descount > 0 && (
              <span
                className="desconto"
                style={{ color: `#${plano.cores.colorDescount}` }}
              >
                {" "}
                ({plano.descount}% OFF)
              </span>
          ...
          <div
            className="containerPricePackage"
            style={{
              background: `linear-gradient(135deg,#${plano.cores.bgPrice1}, #${plano.cores.bgPrice2})`,
              marginBottom: "20px",
            }}
          >
